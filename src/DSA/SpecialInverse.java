...
//2. The key constraint is if the number is 5 digits long, it'll contain all the digits from 1 to 5 without missing any and without
// repeating any. e.g. 23415 is a 5 digit long number containing all digits from 1 to 5 without missing and repeating any digit from 1 to 5.
...
//            int InvertedPosition = OriginalDigit;
            ...
            Number = Number + InvertedDigit * (int)Math.pow(10, OriginalDigit-1);
